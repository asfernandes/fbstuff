...
select count(*) from copy_message(9000000, 'abcdefghij');
select count(*) from copy_message_5c(9000000, 'abcdefghij');
select count(*) from copy_message_nn(9000000, 'abcdefghij');
select count(*) from copy_message_5c_nn(9000000, 'abcdefghij');
select count(*) from copy_message_xbig(9000000, 1234567890);
select count(*) from copy_message_5c_xbig(9000000, 1234567890);
select count(*) from copy_psql(9000000, 'abcdefghij');
select count(*) from copy_psql_5c(9000000, 'abcdefghij');
